...
- At the beginning of any prompt (or in [AGENTS.md](https://agents.md/)/[CLAUDE.md](https://code.claude.com/docs/en/memory)), you can type "Help me follow the policy at asen3502.com/ai-policy", and the LLM will answer in a way that helps you to understand.
