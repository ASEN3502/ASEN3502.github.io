# Export newton-systems.jl to a static HTML page (newton-systems.html).
#
#   julia --project=@pluto -e 'import Pkg; Pkg.add("Pluto")'   # once
#   julia --project=@pluto export.jl
#
# newton-systems.jl is a plain Julia script.  This turns it into a Pluto
...
src = joinpath(@__DIR__, "newton-systems.jl")
out = joinpath(@__DIR__, "newton-systems.html")
